    ...
    <div class="container-fluid">
        ...
        @include('admin.partials.ui.page-header', [
            'breadcrumbs' => [
                ...
                ['label' => 'التخزين السحابي', 'url' => route('admin.storage.index')],
                ['label' => 'إضافة'],
            ],
            'title' => 'إضافة مكان تخزين',
            'subtitle' => 'تكوين وجهة تخزين سحابية أو محلية جديدة',
            'actions' => '<a href="' . route('admin.storage.index') . '" class="btn btn-light border btn-wave"><i class="ri-arrow-right-line me-1"></i> رجوع</a>',
        ])
                ...
                <div class="card custom-card form-card">
                    <div class="card-header">
                        <h6 class="mb-0 fw-semibold fs-15">
                            <i class="ri-cloud-line me-1 text-primary"></i> بيانات مكان التخزين
                        </h6>
                    </div>
                    <div class="card-body">
                        <form action="{{ route('admin.storage.store') }}" method="POST" id="storage-form">
                            ...
                            <div class="d-flex gap-2 flex-wrap">
                                ...
                                <a href="{{ route('admin.storage.index') }}" class="btn btn-light border btn-lg px-4">
                                    إلغاء
                                </a>
                            </div>
                        </form>
