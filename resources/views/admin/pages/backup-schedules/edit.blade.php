    ...
    <div class="container-fluid">
        ...
        @include('admin.partials.ui.page-header', [
            'breadcrumbs' => [
                ...
                ['label' => 'الجدولة', 'url' => route('admin.backup-schedules.index')],
                ['label' => 'تعديل'],
            ],
            'title' => 'تعديل: ' . $schedule->name,
            'subtitle' => 'تحديث إعدادات الجدولة',
            'actions' => '<a href="' . route('admin.backup-schedules.index') . '" class="btn btn-light border btn-wave"><i class="ri-arrow-right-line me-1"></i> رجوع</a>',
        ])
                ...
                <div class="card custom-card form-card">
                    <div class="card-header">
                        <h6 class="mb-0 fw-semibold fs-15">
                            <i class="ri-calendar-schedule-line me-1 text-primary"></i> بيانات الجدولة
                        </h6>
                    </div>
                    <div class="card-body">
                        <form action="{{ route('admin.backup-schedules.update', $schedule->id) }}" method="POST">
                            ...
                            <div class="d-flex gap-2 flex-wrap mt-3">
                                ...
                                <a href="{{ route('admin.backup-schedules.index') }}" class="btn btn-light border btn-lg px-4">
                                    إلغاء
                                </a>
                            </div>
                        </form>
