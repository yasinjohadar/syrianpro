<div class="modal fade modal-user-action" id="deleteJobModal" tabindex="-1" aria-hidden="true">
        ...
        <div class="modal-content">
            <form method="POST" id="deleteJobForm">
                ...
                <div class="modal-header">
                    <h5 class="modal-title visually-hidden">حذف الوظيفة</h5>
                ...
                <div class="modal-body text-center">
                    ...
                    <h4 class="mb-2 fw-bold text-danger">تأكيد حذف الوظيفة</h4>
                    <p class="action-modal-user mb-2" id="deleteJobName"></p>
                    <p class="text-muted mb-0 px-md-4">
                        لا يمكن التراجع عن هذا الإجراء. سيتم حذف الوظيفة نهائياً.
                    </p>
                </div>
