         ...
         <header class="app-header">
            ...
            <div class="main-header-container container-fluid">
                ...
                <div class="header-content-right">
                    ...
                    <!-- Start::header-element -->
                    @include('partials.panel-notifications', [
                        'notificationsIndexUrl' => route('company.notifications.index'),
                        'notificationsReadAllUrl' => route('company.notifications.read-all'),
                    ])
                    <!-- End::header-element -->
