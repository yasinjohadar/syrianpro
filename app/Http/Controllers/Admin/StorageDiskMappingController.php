...
class StorageDiskMappingController extends Controller
{
    ...
    public function index()
    {
        ...
        $stats = [
            'total' => StorageDiskMapping::count(),
            'active' => StorageDiskMapping::where('is_active', true)->count(),
            'inactive' => StorageDiskMapping::where('is_active', false)->count(),
        ];

        return view('admin.pages.storage-disk-mappings.index', compact('mappings', 'stats'));
    }
